...
{
    /// <inheritdoc />
    public partial class AddIntialdata : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DealerLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirbagNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarXColors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarXColors_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarXColors_Colors_ColorId",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descriptaion = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarXFeatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarXFeatures_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarXFeatures_FeatureTypes_FeatureTypeId",
                        column: x => x.FeatureTypeId,
                        principalTable: "FeatureTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarXFeatures_Features_FeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatureXFeaturetypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeatureXFeaturetypes_FeatureTypes_FeatureTypeId",
                        column: x => x.FeatureTypeId,
                        principalTable: "FeatureTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FeatureXFeaturetypes_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarXColors_CarId",
                table: "CarXColors",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarXColors_ColorId",
                table: "CarXColors",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_CarXFeatures_CarId",
                table: "CarXFeatures",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarXFeatures_FeatureId",
                table: "CarXFeatures",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_CarXFeatures_FeatureTypeId",
                table: "CarXFeatures",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureXFeaturetypes_FeatureId",
                table: "FeatureXFeaturetypes",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_FeatureXFeaturetypes_FeatureTypeId",
                table: "FeatureXFeaturetypes",
                column: "FeatureTypeId");
